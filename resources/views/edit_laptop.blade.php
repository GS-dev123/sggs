...
<div class="container">
  ...
  @foreach($laps as $lap)
  <form method="post" action="{{route('laptop.update',$lap->id)}}">
  @method('PATCH')
  @csrf
  <div class="row">
    <div class="col">
    <input type="text" name="marca" placeholder="Insira Marca" class="form-control" value="{{$lap->marca}}">
    </div>
    <div class="col">
      <input type="text" name="geracao" placeholder="Insira Geração" class="form-control" value="{{$lap->geracao}}">
    </div>
  </div>
    <div class="row">
    <div class="col">
    <input type="text" name="modelo" placeholder="Insira Modelo" class="form-control" value="{{$lap->modelo}}">
    </div>
    <div class="col">
      <input type="text" name="polegadas" placeholder="Insira Polegadas" class="form-control" value="{{$lap->polegadas}}">
    </div>
  </div>
      <div class="row">
    <div class="col">
      <select class="form-control" name="cap_ram">
        <option >{{$lap->cap_ram}}</option>
        <option>256MB</option>
        <option>512MB</option>
        <option>1GB</option>
        <option>2GB</option>
    ...
    <div class="col">
      ...
      <div class="row">
    <div class="col">
    <input type="text" name="grafica" placeholder="Placa Gráfica" class="form-control" value="{{$lap->grafica}}">
    </div>
    <div class="col">
      <input type="text" name="cap_grafica" placeholder="Capacidade gráfico" class="form-control" value="{{$lap->cap_grafica}}">
    </div>
  </div>
        <div class="row">
    <div class="col">
       <select class="form-control" name="duracao_bateria">
        <option >{{$lap->duracao_bateria}}</option>
        <option>1H</option>
        <option>2H</option>
        <option>3H</option>
        <option>4H</option>
    ...
    <div class="col">
       <select class="form-control" name="volts_carregador">
        <option >{{$lap->volts_carregador}}</option>
        <option>18V</option>
        <option>18.5V</option>
        <option>19V</option>
        <option>19.5V</option>
  ...
  <div class="row">
    <div class="col">
      ...
      <label>Problema</label>
        ...
        <div class="col-sm-12">
      <textarea name="problema" class="form-control">{{$lap->problema}}</textarea>
    </div>
    <div class="col-sm-12">
