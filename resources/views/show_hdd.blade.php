...
@foreach($hdds as $hdd)
<h1 class="text-center">Detalhes da Memoria HDD</h1>
 <h3>ID: <b>{{$hdd->id}}</b></h3>
 <h3>Marca: <b>{{$hdd->marca}}</b></h3>
 <h3>Tipo: <b>{{$hdd->tipo}}</b></h3>
 <h3>Capacidade: <b>{{$hdd->capacidade}}</b></h3>
 <h3>Modelo: <b>{{$hdd->modelo}}</b></h3>
  @endforeach
</div>
