    ...
    <thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$hdd->marca}}</td>
          <td>{{$hdd->tipo}}</td>
          <td>{{$hdd->capacidade}}</td>
          <td>{{$hdd->modelo}}</td>
          <td class="action"><a href="{{route('hdd.show',$hdd->id)}}" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
            <a href="{{route('hdd.edit',$hdd->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-pencil" style="color:white"></i></a>
            <a href="{{route('hdd.delete', $hdd->id)}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
        </tr>
        @endforeach
    </tbody>
</table>
